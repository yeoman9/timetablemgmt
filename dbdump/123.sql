...
CREATE TABLE `BRANCH` (
  ...
  `totalTeachers` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
INSERT INTO `BRANCH` VALUES (1,'Computer Engineering','CE',NULL),(2,'Electronics & Communication','EC',NULL),(3,'Mechanical Engineering','ME',NULL),(4,'Electrical Engineering','EE',NULL);
...
INSERT INTO `LOGIN` VALUES (1,'admin@admin.com','12345','A','admin',1),(2,'mayur@teacher.com','12345','A','mayr',4),(3,'sanket@teacher.com','12345','B','snkt',4),(4,'hitesh@teacher.com','12345','B','htsh',4),(5,'arpit@teacher.com','12345','B','arpt',4),(6,'clerk@clerk.com','12345','A','clerk',5);
